...
(function(factory) {
    ...
    Slick.prototype.buildOut = function() {
        ...
        $('iframe[data-lazy]', _.$slider).not('[src]').addClass('slick-loading');
    ...
    Slick.prototype.lazyLoad = function() {
        ...
        $('iframe[data-lazy]', loadRange).not('[src]').each(function() {
            $(this).attr('src', $(this).attr('data-lazy')).removeClass('slick-loading');
        });

        if (_.currentSlide >= _.slideCount - _.options.slidesToShow) {
            cloneRange = _.$slider.find('.slick-cloned').slice(0, _.options.slidesToShow);
            $('iframe[data-lazy]', cloneRange).not('[src]').each(function() {
                $(this).attr('src', $(this).attr('data-lazy')).removeClass('slick-loading');
            });
    ...
    Slick.prototype.progressiveLazyLoad = function() {
        ...
        imgCount = $('iframe[data-lazy]').not('[src]').length;

        if (imgCount > 0) {
            targetImage = $($('iframe[data-lazy]', _.$slider).not('[src]').get(0));
